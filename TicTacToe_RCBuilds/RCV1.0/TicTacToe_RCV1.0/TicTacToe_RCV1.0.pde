...
void draw(){ // draw game board, O's and X's, print game state.
  ...
  if (gameState == true){ // if game is still going
    ...
    drawHint(100,120,1); // horizontal move hint
    drawHint(300,120,2);
    drawHint(500,120,3);
    drawHint(100,320,4);
    drawHint(300,320,5);
    ...
    drawHint(300,520,8);
    drawHint(500,520,9);
    drawHint(100,120,10); // vertical move hint
    drawHint(100,320,11);
    drawHint(100,520,12);
    drawHint(300,120,13);
    drawHint(300,320,14);
    ...
    drawHint(500,320,17);
    drawHint(500,520,18);
    drawHint(100,120,19); // diagonal move hint
    drawHint(300,320,20);
    drawHint(500,520,21);
    drawHint(100,520,22);
    drawHint(300,320,23);
  ...
  if (toggleCode == 1){
      ...
      textAlign(CENTER);
      fill(68,0,107);
      text("Game Cleared!",525,640);}
  if (toggleCode == 2){
      textFont(manrope18);
      textAlign(CENTER);
      fill(68,0,107);
      text("Game Saved!",525,640);}
  if (toggleCode == 3){
      textFont(manrope18);
      textAlign(CENTER);
      fill(68,0,107);
      text("Game Restored!",525,640);}
    fill(224,224,224);
  }
